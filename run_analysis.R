...
run_analysis <- function(directory = ".") {
    ...
    train <- load_table(directory, "train", activity_labels, features)

    # load test activities data    
    test <- load_table(directory, "test", activity_labels, features)
...
# Author: Steve
###############################################################################
load_table <- function(directory, data_type, activity_labels, features) {
